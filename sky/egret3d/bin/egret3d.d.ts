...
declare namespace egret3d {
    ...
    class Vector4 extends paper.BaseRelease<Vector4> implements IVector4, paper.ICCS<Vector4>, paper.ISerializable {
         ...
         * @param input 输入向量。
         */
        inverse(input: Readonly<IVector3>): this;
        /**
         * 向量与标量相乘运算。
...
declare namespace paper {
    ...
    class DisposeCollecter extends SingletonComponent {
         ...
         * 暂存此帧更改过父级的实体。
         */
        readonly parentChangedGameObjects: GameObject[];
        /**
         * 暂存此帧销毁的全部组件。
         */
...
declare namespace egret3d {
    ...
    class Transform extends paper.BaseComponent {
         ...
         * 该组件是否包含某个子（孙）级变换组件。
         */
        contains(transform: Transform): boolean;
        /**
         * 更改该组件的父级变换组件。
         * @param parent 父级变换组件。
         * @param worldTransformStays 是否保留当前世界空间变换。
         */
        setParent(parent: Transform | null, worldTransformStays?: boolean): this;
        /**
         *
         */
...
declare namespace egret3d {
     ...
     * - 与 Y 轴对齐。
     */
    class CylinderCollider extends paper.BaseComponent implements IRaycast {
        readonly colliderType: ColliderType;
        /**
         * 该圆柱（锥）的顶部半径。
         */
...
declare namespace egret3d {
    class PostProcessRenderContext extends paper.BaseRelease<PostProcessRenderContext> {
        ...
        render(): void;
        blit(src: Texture, mat?: Material | null, dest?: BaseRenderTarget | null): void;
        clear(): void;
    ...
    class MotionBlueEffect extends CameraPostProcessing {
        ...
        private _previousViewProjectionMatrix;
        constructor();
        render(context: PostProcessRenderContext): void;
